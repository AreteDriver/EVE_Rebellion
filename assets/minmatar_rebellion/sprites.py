...
from constants import (
    ...
    COLOR_AMARR_DARK, COLOR_AMARR_HULL, COLOR_MINMATAR_ACCENT,
    COLOR_MINMATAR_DARK, COLOR_MINMATAR_HULL, ENEMY_STATS,
    JAGUAR_DAMAGE_BONUS, JAGUAR_HULL_BONUS, JAGUAR_SHIELD_BONUS,
    JAGUAR_SPEED_BONUS, PLAYER_BASE_FIRE_RATE, PLAYER_MAX_ROCKETS,
    ...
    WOLF_ARMOR_BONUS, WOLF_DAMAGE_BONUS, WOLF_HULL_BONUS, WOLF_SPEED_BONUS
)
