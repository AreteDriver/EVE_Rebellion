...
class ShipRoster:
    ...
    def _load_config(self):
        ...
        try:
            ...
            print(
                f"[ShipRoster] Loaded {sum(len(s) for s in self.ships.values())} ships from config"
            )
            ...
            "minmatar": [
                {
                    ...
                    "available_chapters": ["minmatar_rebellion"],
                    "unlock": "default",
                },
                {
                    "id": "wolf",
                    ...
                    "tier": "t2",
                    "stats": {"hull": 180, "shield": 150, "speed": 320, "damage": 1.4},
                    "available_chapters": ["minmatar_rebellion"],
                    "unlock": "rebellion_boss_7",
                },
                {
                    "id": "jaguar",
                    "name": "Jaguar",
                    ...
                    "class": "assault_frigate",
                    "tier": "t2",
                    "stats": {"hull": 160, "shield": 200, "speed": 380, "damage": 1.3},
                    "available_chapters": ["minmatar_rebellion"],
                    "unlock": "rebellion_boss_13",
                },
            ],
            "amarr": [
                {
                    ...
                    "class": "frigate",
                    "tier": "t1",
                    "stats": {"hull": 80, "shield": 60, "speed": 380, "damage": 1.0},
                    "available_chapters": ["minmatar_rebellion"],
                    "unlock": "default",
                },
            ],
    ...
    def get_playable_ships(
        self, faction: str, chapter: str, unlocked_only: bool = True
    ) -> List[Dict]:
        """
